...
for (i = 0; i < favoriteFonts.length; i++) { //adding cards inside main-section
    ...
    newDiv.innerHTML = favoriteFonts[i].fontName + "<div id='add'><img src='../assets/add.png' id='addicon'></div> " + "<br>" + "<div class='creator'>" + favoriteFonts[i].fontCreator + "</div>" + "<div class='content' style='font-family:" + favoriteFonts[i].fontName + "'>" + sampleText + "</div>";
